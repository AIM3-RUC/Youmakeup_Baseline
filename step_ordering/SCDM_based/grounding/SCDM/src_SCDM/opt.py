...
def default_options():
    ...
    options['ficial_label_pos_threshold'] = 0.5
    options['ficial_label_neg_threshold'] = 0.5
    ...
    options['ficialposloss_weigth'] = 0.5
    options['ficialnegloss_weigth'] = 0.5
    ...
    options['ficial_map_path'] = '../../../data/facial_map'
